...
\denseouterlist{
	\entry{\textbf{Vicechair of the Jury} of the Polish Olympiad in Informatics (2023 -- 2025).
		\innerlist{
			\entry{introduced multiple minor and major changes to the preparations of the competition,}
			\entry{initialized the creation of a \link{https://github.com/sio2project/sinol-make}{tool for task preparation}
				and mentored a student during its implementation through code review and guidance in decisions.}
			\entry{overseeing the competitions and making the main decisions in case of problems.} 
		}
	}
