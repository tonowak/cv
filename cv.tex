...
\denseouterlist{
	\entry{ICPC World Finals: \textbf{finalist of ICPC WF 2022 and ICPC WF 2023} (both will happen in the future).}
...
\denseouterlist{
	\entry{\textbf{Vicechair of the Jury} of the Polish Olympiad in Informatics (2023 -- 2025).
		\innerlist{
			...
			\entry{Among other things, I hired people, changed how we advertised to high school students,
				redesigned e.g. posters, changed the format of the competition, re-initiated
				multiple projects.
			}
			\entry{Initiated and supervised:
				\begin{itemize}
	...
	\entry{Member of the Jury and the Task Commision of the Polish Olympiad in Informatics (2020 -- Current).}
